...
class Trainer:
    ...
    def train_function(self, thread_index, sess, summary_writer):
    ...
    def run(self):
        global_network = A3CGlobalNetwork()

        for idx in range(cfg.threads_num):
            training_thread = A3CTrainingThread(idx, global_network)
